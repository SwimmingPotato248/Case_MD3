...
module.exports.authController = (req, res) => {
  ...
  if (path === "/auth") {
    fs.readFile(
      "C:\\Users\\HP.DESKTOP-35U4HVA\\WebstormProjects\\CASE_MD3\\Case_MD3\\src\\views\\index.html",
      "utf-8",
      async (err, createHtml) => {
        if (err) {
          console.log(err);
        } else {
  ...
  if (path === "/auth/login") {
    if (req.method === "GET") {
      fs.readFile(
        "C:\\Users\\HP.DESKTOP-35U4HVA\\WebstormProjects\\CASE_MD3\\Case_MD3\\src\\views\\login.html",
        "utf-8",
        (err, loginHtml) => {
          if (err) {
            console.log(err);
  ...
  if (path === "/auth/logout") {
    if (req.method === "GET") {
      fs.readFile(
        "C:\\Users\\HP.DESKTOP-35U4HVA\\WebstormProjects\\CASE_MD3\\Case_MD3\\src\\views\\logout.html",
        "utf-8",
        (err, logoutHtml) => {
          if (err) {
            console.log(err);
  ...
  if (path === "/auth/user") {
    fs.readFile(
      "C:\\Users\\HP.DESKTOP-35U4HVA\\WebstormProjects\\CASE_MD3\\Case_MD3\\src\\views\\user.html",
      "utf-8",
      (err, createHtml) => {
        if (err) {
          console.log(err);
